    ...
    return (
		<div className="p-10">
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center md:justify-between mx-auto gap-8">
				<div className="card w-full h-[500px] border border-green-600 shadow-lg shadow-green-100 p-5 hover:scale-105">
					<div>
					...
					<div>
						<p>
							Enjoy our delicious dishes from the comfort of your
							home with our convenient takeaway service. Order
							online or by phone and pick up your order at your
							preferred time.
						</p>
					</div>
				</div>
				<div className="card w-full h-[500px] border border-green-600 shadow-lg shadow-green-100 p-8 hover:scale-105">
					...
					<div>
						<p>
							Experience hassle-free payments with our secure
							digital payment options. Pay for your meal
							conveniently using credit/debit cards, mobile
